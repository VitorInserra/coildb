...
def test_create_faculty_recipient(override_db, client):
    ...
    db_recipient = override_db.execute(text("SELECT * FROM faculty WHERE 'Last Name' = :last_name"), {"last_name": "jones"}).fetchall()
...
def test_delete_faculty_recipient(override_db, client):
    ...
    db_recipient = override_db.execute(text("SELECT * FROM faculty WHERE 'Last Name' = :last_name"), {"last_name": "jones"}).fetchone()
